#' From a given data set find test statistic value and corresponding critical value
#'
...
#' AMaxt3crit(g1,g2,g3,0.05)
#'
#'
#' @export
AMaxt3crit<-function(g1,g2,g3,alpha)
{
  fun1<-function(n1,n2,n3,v1,v2,v3)
  {
    ...
    nu2=n2/N
    nu3=n3/N
    d1=sqrt(nu1*v2+nu2*v1)
    d2=sqrt(nu2*v3+nu3*v2)
